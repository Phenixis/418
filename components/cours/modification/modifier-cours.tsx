    ...
    return (
        <>
            {isCreateCourseDialogOpen && (
                <button
                    type="button"
                    aria-label="Fermer le dialogue de modification de cours"
            ...
            >
                <DialogTrigger asChild>
                    <Button variant="default">Modifier un cours</Button>
                </DialogTrigger>
                <DialogContent className="z-50">
                    <DialogHeader>
                        <DialogTitle className="h2 font-normal">Modifier un cours</DialogTitle>
                        <DialogDescription hidden>
                            Dialogue de modification de cours
                        </DialogDescription>
                    </DialogHeader>
                    <form action={formAction} className="w-full">
                        ...
                        <DialogFooter className="flex-col sm:flex-col">
                            ...
                            <Button type="submit" variant="big" className="" disabled={pending || !isFormValid}>
                                Modifier
                            </Button>
                            <Button type="reset" variant="outline" className="" disabled={pending || !isFormValid}>
                                Annuler
                            </Button>
                        </DialogFooter>
                    </form>
