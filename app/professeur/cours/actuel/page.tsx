...
export default function AppelPage() {
    ...
    return (
        <section className="container mx-auto flex flex-col py-10 gap-6">
            ...
            {/* Placeholder - trombinoscope (user story à venir) */}
            <div className="w-full rounded-xl border border-dashed border-faded bg-background-alternative flex items-center justify-center min-h-96">
                <p className="font-faded">Trombinoscope - à implémenter</p>
            </div>
