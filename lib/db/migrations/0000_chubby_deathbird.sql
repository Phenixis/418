...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "student" ADD CONSTRAINT "student_group_id_group_groupId_fk" FOREIGN KEY ("group_id") REFERENCES "public"."group"("groupId") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
